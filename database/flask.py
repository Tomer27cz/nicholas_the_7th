...
#
# # Guild variables
# def flask_guild_last_updated(db: SQLAlchemy, guild_id: int) -> dict or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Guild).filter_by(id=guild_id).with_entities(data_classes.Guild.last_updated)
#         if response is None:
#             return None
#         return response[0][0]
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.GuildData).filter_by(id=guild_id).with_entities(data_classes.GuildData.key)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_loop(db: SQLAlchemy, guild_id: int) -> bool or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.loop)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_buffer(db: SQLAlchemy, guild_id: int) -> int or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.buffer)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_response_type(db: SQLAlchemy, guild_id: int) -> str or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.response_type)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_search_query(db: SQLAlchemy, guild_id: int) -> str or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.search_query)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_language(db: SQLAlchemy, guild_id: int) -> str or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.language)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_is_radio(db: SQLAlchemy, guild_id: int) -> bool or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.is_radio)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_volume(db: SQLAlchemy, guild_id: int) -> float or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.volume)
#         if response is None:
#             return None
#         return response[0][0]
# def flask_guild_options_buttons(db: SQLAlchemy, guild_id: int) -> bool or None:
#     """
...
#     """
#     with db.session.no_autoflush:
#         response = db.session.query(data_classes.Options).filter_by(id=guild_id).with_entities(data_classes.Options.buttons)
#         if response is None:
#             return None
#         return response[0][0]
# # Guild Save
